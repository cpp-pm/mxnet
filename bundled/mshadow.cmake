...
elseif(BLAS STREQUAL "apple")
  if(HUNTER_ENABLED)
    ...
    set(Accelerate_LIBRARIES accelerate::accelerate)
    if(NOT EXISTS "${CMAKE_OSX_SYSROOT}")
      message(FATAL_ERROR "CMAKE_OSX_SYSROOT doesn't exist: '${CMAKE_OSX_SYSROOT}'")
    endif()
    set(
        Accelerate_INCLUDE_DIR
        ${CMAKE_OSX_SYSROOT}/System/Library/Frameworks/Accelerate.framework/Versions/A/Frameworks/vecLib.framework/Versions/A/Headers/
    )
    if(NOT EXISTS "${Accelerate_INCLUDE_DIR}")
      message(FATAL_ERROR "Accelerate_INCLUDE_DIR doesn't exist: '${Accelerate_INCLUDE_DIR}'")
    endif()
  else()
  find_package(Accelerate REQUIRED)
  endif()
